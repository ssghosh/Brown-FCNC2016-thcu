...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/user/e/ecoleman/Brown-FCNC2016-thcu/SAMPLES/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/user/e/ecoleman/Brown-FCNC2016-thcu/SAMPLES/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/user/e/ecoleman/Brown-FCNC2016-thcu/SAMPLES/bin/${ananame}.cpp
